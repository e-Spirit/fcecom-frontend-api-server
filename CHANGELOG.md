## [1.8.2](https://github.com/e-Spirit/fcecom-frontend-api-server/compare/v1.8.1...v1.8.2) (2025-09-01)

### Changes

* Updated version number to be consistent with client package.

## [1.8.1](https://github.com/e-Spirit/fcecom-frontend-api-server/compare/v1.8.0...v1.8.1) (2025-08-11)

### Changes

* Updated version number to be consistent with client package.

## [1.8.0](https://github.com/e-Spirit/fcecom-frontend-api-server/compare/v1.7.0...v1.8.0) (2025-05-23)
...
* Added the ability to get the available locales in a FirstSpirit project and additionally fixed formatting issues.

## [1.5.0](https://github.com/e-Spirit/fcecom-frontend-api-server/compare/v1.4.3...v1.5.0) (2025-03-20)
